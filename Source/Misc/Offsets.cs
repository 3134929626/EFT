namespace Offsets
{
    ...
    public struct Player // EFT.Player : MonoBehaviour, 
    {
        ...
        public const uint Corpse = 0x420; // EFT.Interactive.Corpse
        public const uint Profile = 0x648; // [620] <Profile>k__BackingField : EFT.Profile
        public const uint InventoryController = 0x6A0; // [678] _inventoryController : -.Player.PlayerInventoryController
        public const uint PlayerBody = 0xB8; // [B8] _playerBody : EFT.PlayerBody
        public const uint Location = 0x610; // [5E8] <Location>k__BackingField : String
        public const uint Physical = 0x658; // [630] Physical : -.GClass
        ...
        public const uint HandsController = 0x6A8; // [680] _handsController : -.Player.AbstractHandsController
    }
    ...
    public struct Profile // EFT.Profile
    {
        ...
        public const uint SkillManager = 0x58; //[60] Skills : EFT.SkillManager
        public const uint QuestsData = 0x70; // [78] QuestsData : System.Collections.Generic.List<GClass342B>
    }
    ...
    public struct ObservedPlayerView // [Class] EFT.NextObservedPlayer.ObservedPlayerView : MonoBehaviour
    {
        ...
        public const uint IsAI = 0x109; // [108] boolean_0x108 : Boolean
    ...
    {
        public const uint Intensity = 0xA4; //[A4] _shakeIntensity : Single
    }
    ...
    {
        public const uint MapName = 0x78; // [50] string_0x50 : String
        public const uint MainPlayer = 0x190; // [140] MainPlayer : EFT.Player
        public const uint ExfilController = 0x20; // [20] gClass11CD_0x20 : -.GClass11CD
        public const uint LootList = 0x100; // [C0] LootList : System.Collections.Generic.List<GInterface1C43>
        public const uint RegisteredPlayers = 0x128; // [E8] RegisteredPlayers : System.Collections.Generic.List<IPlayer>
        public const uint Grenades = 0x1E8; // [198] Grenades : -.GClass0822<Int32, Throwable>
        public const uint RaidStarted = 0x268; // [210] boolean_0x210 : Boolean
    ...
    {
        public const uint ItemOwner = 0x128; // [118] ItemOwner : -.GClass27E2
        public const uint Template = 0x130; // [120] Template : String
    }
