...
namespace eft_dma_radar
{
    ...
    public class Player
    {
        ...
        public void SetRotationFr2(Vector3 brainrot)
        {
            if (!this.IsLocalPlayer || !this.IsAlive || this.MovementContext == 0)
            {
                return;
            ...
            //Memory.WriteValue(playamanaga._proceduralWeaponAnimation + Offsets.MovementContext.Rotation, brainrot);
        }
        /// <summary>
