    ...
    public class Aimbot
    {
        ...
        public class KeyChecker
        {
            ...
            private void CheckKey(object sender, ElapsedEventArgs e)
            {
                ...
                //{
                //    //printf("鼠标侧键2按下\r\n");
                _bHeld = KmBox.kmNet_monitor_mouse_side2() == 1 ? true : false;
        ...
        public Vector3 GetHead(Player player)
        {
            ...
            var pointer = Memory.ReadPtrChain(boneMatrix, [0x20 + ((frmMain.锁腿 ? (uint)PlayerBones.HumanRThigh2 : bone) * 0x8), 0x10]);
        ...
        public bool GetHeadScr(Player player, out Vector2 screen, out Vector3 pos)
        {
            screen = new Vector2();
            pos = new Vector3();
            if (player.BoneTransforms != null && player.BoneTransforms.Count != 0 && !player.IsLocalPlayer && (!player.IsFriendlyActive || frmMain.瞄准队友) && player.IsAlive && player.IsActive && Vector3.Distance(player.Position, LocalPlayer.Position) < Program.Config.BulletSpeed)
            {
        ...
        public Vector3 预判(Vector3 newPosition, Player player)
        {
            ...
            var localbone = new Vector3(this.LocalPlayer.BonePositions.X, this.LocalPlayer.BonePositions.Z, this.LocalPlayer.BonePositions.Y);
        ...
        public bool GetHeadScr2(Player player, out Vector2 screen, out Vector3 pos)
        {
            ...
            {
                //Vector3 temp = GetHead(player);
                Vector3 temp = frmMain.锁腿 ? player.BoneTransforms[1].GetPosition() : player.BoneTransforms[0].GetPosition();
        ...
        public void AimerBotterKmBox()
        {
            ...
            try
            {
                ...
                //var ammo_template = Memory.ReadPtrChain(this.LocalPlayer.PlayerBody, [Offsets.Player.HandsController, 0x60, 0x40, 0x190]);
                //if (ammo_template == 0)
                //{
                //    bullet_speed = 0;
                //    ballistic_coeff = 0;
                ...
                //bool bHeld = keyboard.IsKeyDown(0x06);
